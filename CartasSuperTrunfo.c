...
main()  
{
    ...
    char estado1, estado2, codigo1[2], codigo2[2], cidade1[30], cidade2[30] ;
			...
			if (cont==1)
			 {
			  ...
			  scanf("%f", &pib1);
			  printf(" Digite a Qts de pontos turistido da cidade 1 => ");
			  ...
			  scanf("%f", &pib2);
			  printf(" Digite a Qts de pontos turistido da cidade 2 => ");
